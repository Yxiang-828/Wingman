...
app.delete(
  "/api/v1/user/delete-account/:user_id",
  createApiProxy("/user/delete-account/:user_id"),
);
...
// CHAT ENDPOINTS
app.get("/api/v1/chat/:user_id", createApiProxy("/chat/:user_id"));
app.post("/api/v1/chat/", createApiProxy("/chat"));
