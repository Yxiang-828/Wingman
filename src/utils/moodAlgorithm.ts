...
export class MoodManager {
  ...
  private readonly MOOD_WEIGHTS = {
    productive: 0.25,  // ✅ Reduced from bias
    chill: 0.25,       // ✅ Increased
    focused: 0.20,     // ✅ New mood
    creative: 0.15,    // ✅ New mood  
    energetic: 0.15    // ✅ New mood
  };
  ...
  private changeMood(): void {
    ...
    if (window.electronAPI) {
      window.electronAPI.send('mood-changed', newMood);
    }
