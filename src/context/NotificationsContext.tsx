...
// Advanced localStorage manager with day-based expiry
...
export const NotificationsProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  // Load dismissed notifications using the manager
  useEffect(() => {
    try {
      // Load read status
  ...
  // Use advanced manager for dismissing
