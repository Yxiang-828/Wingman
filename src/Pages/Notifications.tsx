...
// Countdown Timer Component (keeping existing)
  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      try {
        ...
        if (diff <= 0) {
          // Trigger callback when timer hits 0 (only once)
...
const Notifications: React.FC = () => {
  ...
  // Filter items to exclude those with alerts set (optional - or keep them visible)
                ...
                >
                  ...
                  <div className="notification-content">
                    ...
                    <CountdownTimer
                      ...
                      type="event"
                      onComplete={() => handleTimerComplete(event, "event")} // onComplete handler
                    />
                  </div>
                  <div className="notification-actions">
                    {/* Alert Me button for events */}
                    <button
                      className={`notification-alert-btn ${
