              ...
              <>
                ...
                <div className="detail-popup-content">
                  ...
                  <div className="detail-text">
                    {item.title}
                    {isRecurringTask(item as Task) && (
                      <span
                        className="recurring-badge-popup"
                  ...
                  {isRecurringTask(item as Task) && (
                    <div className="detail-recurring-info">
                      <span className="recurring-icon">♻️</span>
                      <span>
                        This is a recurring task that automatically creates new
                        instances based on your schedule.
                      </span>
                    </div>
                  )}
                  ...
                  <div className="detail-popup-header">
                    <div
                      className={`detail-type ${
                        (item as CalendarEvent).type || "default"
                      }`}
                    >
