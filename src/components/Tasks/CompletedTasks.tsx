...
const CompletedTasks: React.FC = () => {
  ...
  // Direct SQLite data fetching for completed tasks
  const fetchCompletedTasks = useCallback(async () => {
    ...
    try {
      ...
      if (filterDate) {
        // Direct SQLite call for specific date
        ...
        console.log(
          `CompletedTasks: Loaded ${completedTasks.length} completed tasks for ${filterDate}`,
        );
      } else {
        ...
        console.log(
          `CompletedTasks: Loaded ${totalCount} completed tasks across ${Object.keys(tasksByDate).length} days`,
        );
      }
    } catch (error) {
